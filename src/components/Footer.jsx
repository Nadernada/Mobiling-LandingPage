    ...
    <footer className={`${styles.mainLayout} py-[15px] lg:py-[35px] bg-blue-800`}>
      <div className='flex flex-col lg:flex-row w-full justify-between pt-[36px] lg:pt-[72px]'>
        <div className='flex flex-col lg:w-1/3 items-start'>
          <div className='flex flex-row justify-center items-center'>
            <img src='./src/assets/logo-b&w.svg' className='w-[30px] h-[34px] object-contain mr-[12px]' />
          ...
          <div className='flex flex-row justify-center items-center gap-[24px] mt-[40px]'>
            <img src='./src/assets/twitter.svg' alt='facebook' className={`${styles.iconsSm}`} />
            <img src='./src/assets/facebook.svg' alt='facebook' className={`${styles.iconsSm}`} />
            <img src='./src/assets/linkedin.svg' alt='linkedin' className={`${styles.iconsSm}`} />
            <img src='./src/assets/instagram.svg' alt='instagram' className={`${styles.iconsSm}`} />
          </div>
        </div>
        <FooterLinks />
      </div>
      <div className='flex flex-col lg:flex-row justify-between items-center border-t-[1px] border-light py-[40px] mt-[40px] xl:mt-0' >
        ...
        <button className='bg-transparent text-light flex flex-row items-center justify-center mt-[30px] lg:mt-0'><span>
          <img src='./src/assets/globe.svg' alt='globe' className={`${styles.iconsSm} pr-[16px]`} /></span>
          English<span>
          <img src='./src/assets/arrow-right.svg' alt='arrow-right' className={`${styles.iconsSm} pl-[16px]`} /></span>
        </button>
      </div>
    </footer>
  )
