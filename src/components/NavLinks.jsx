    ...
    <div className={`${active===index ? 'border-b-dark border-b-[2px]' : ''} flex flex-row justify-between px-[24px] py-[12px] cursor-pointer transition-all relative group`} onClick={() =>handleClick(index)}>
        ...
        {subtitles ? (
            <div className=' flex flex-col lg:flex-row justify-between items-center  my-[10px] lg:my-0'>
              ...
              <img src='/Mobiling-LandingPage/arrow-down.svg' alt='arrow-down' className='w-[16px] h-[16px] object-contain ml-[8px] rotate-180 group-hover:rotate-0 origin-center transition-all duration-500' />
              </div>
              <ul className='scale-0 hidden lg:flex group-hover:flex group-hover:scale-100 hover:flex flex-col relative lg:absolute w-[100vw] lg:w-full bg-blue-400 py-[20px] px-4 top-[10%] lg:top-[100%] left-0 origin-top divide-y-2 text-mid lg:rounded-b-[16px] transition ease-in-out duration-500'>
