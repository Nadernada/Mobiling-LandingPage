  ...
  return (
    <nav className='w-full h-[120px] py-[36px] lg:px-[80px] xl:px-[140px] px-[50px] flex justify-between items-center '>
      <div className='flex flex-row justify-center items-center'>
        <img src='./assets/logo-colored.svg' className='w-[30px] h-[34px] object-contain mr-[12px]' />
      ...
      <img src={`${isOpen ? './assets/close.svg' : './assets/burger-menu.svg'}`} alt='menu' className={`block lg:hidden w-[32px] h-[32px] object-contain z-30 cursor-pointer transition-all`} onClick={()=>setIsOpen(!isOpen)}/>
    </nav>
  )
}
